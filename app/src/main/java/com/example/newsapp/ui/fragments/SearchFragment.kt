...
import com.example.newsapp.until.Constants
...
import com.example.newsapp.until.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val shouldPaginate =
                isNoErrors && isNotLoadingandNotLastPage && isAtlastItem && isNotArBeginning && isTotalMoreThanVisible && isScrolling
            if (shouldPaginate) {
                newsViewModel.searchNews(binding.searchEdit.text.toString())
                isScrolling = false
